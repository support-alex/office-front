          ...
          <div class="login-form login-signin">
            ...
            >
              ...
              <div class="pb-lg-0 pb-5">
                ...
                <div v-if="!disabledBtn" @click="activateGoogle()" class="btn btn-danger font-weight-bolder">Login with Google</div>
                <GoogleLogin  style="widht:1px !important;"   :params="params" :renderParams="renderParams" :onSuccess="onSuccess" :onFailure="onFailure"></GoogleLogin>
              </div>
            </form>
          </div>
          <!--end::Signin-->
...
export default {
  ...
  methods: {
    ...
    // activateGoogle() {
    //   this.disabledBtn = !this.disabledBtn;
    //   const btn = document.querySelector('.abcRioButtonContentWrapper');
    //   if (btn) {
    //     btn.click();
    //   } else {
    //     // อาจแจ้งเตือน user หรือ ลองหาใหม่หลัง delay เล็กน้อย
