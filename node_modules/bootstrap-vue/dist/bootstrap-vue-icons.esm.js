...
var VueProto = OurVue.prototype; // --- Getter methods ---
...
var BVIconBase = /*#__PURE__*/OurVue.extend({
  name: NAME_ICON_BASE,
  functional: true,
  props: props,
...
var makeIcon = function makeIcon(name, content) {
  ...
  return /*#__PURE__*/OurVue.extend({
    name: iconName,
    functional: true,
    props: omit(props, ['content']),
    render: function render(h, _ref) {
      var data = _ref.data,
          props = _ref.props;
...
var iconProps = omit(props, ['content']);
...
var BIcon = /*#__PURE__*/OurVue.extend({
  name: NAME_ICON,
  functional: true,
  props: props$1,
  render: function render(h, _ref) {
...
var BIconstack = /*#__PURE__*/OurVue.extend({
  name: NAME_ICONSTACK,
  functional: true,
  props: props$2,
  render: function render(h, _ref) {
